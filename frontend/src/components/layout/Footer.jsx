    ...
    <footer className="px-3 pt-4 lg:px-9 border-t-2 bg-gray-50">
      <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        <div className="sm:col-span-2">
          <a href="#" className="inline-flex items-center" aria-label="Company Logo">
            <img
              src="/assets/logo.png"
              alt="logo"
              className="h-8 "
          ...
          <div className="mt-6 lg:max-w-xl">
            <p className="text-sm text-gray-800">
              ...
              dignissim lorem id, imperdiet interdum mauris. Vestibulum ultrices sed libero non
              porta. Vivamus malesuada urna eu nibh malesuada, non finibus massa laoreet. Nunc nisi
              velit, feugiat a semper quis, pulvinar id libero. Vivamus mi diam, consectetur non
              orci ut, tincidunt pretium justo. In vehicula porta molestie. Suspendisse potenti.
            </p>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="flex items-center gap-1 px-2">
            <a href="#" className="w-full min-w-xl" aria-label="Playstore Link">
              <img
