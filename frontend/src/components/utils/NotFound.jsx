export default function NotFound() {
    return (
        <div>
            <section class="bg-[#f1f1f1] h-screen flex items-center dark:bg-gray-900">
                <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                    <div class="mx-auto max-w-screen-sm text-center">
                        ...
                        <p class="mb-4 text-lg font-light text-gray-500 dark:text-gray-400">Page will be available by 26 Jan 2025 </p>
                    </div>
                </div>
            </section>
        </div>
