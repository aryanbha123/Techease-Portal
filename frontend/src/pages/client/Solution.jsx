          ...
          <div key={question._id} className='flex justify-between gap-5'>
            <div className='mb-8 flex-1 px-4 rounded-lg'>
              <h1 className='mb-6 font-bold'>
                Q{(currentPage - 1) * questionsPerPage + index + 1}: {question.question}
              </h1>
              {question.image && (
                <img
                  src={question.image}
              ...
              <p  className='overflow-x-hidden h-[calc(100vh-200px)]  overflow-y-scroll' >
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione aperiam quam molestiae aliquam. Iure, a mollitia reprehenderit officia sit, et cumque atque commodi ipsam, quasi vel magni voluptates necessitatibus doloribus?
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Eius vel ut blanditiis porro, fugit quod veritatis nobis consequatur laborum repudiandae itaque eaque eos harum impedit atque modi nisi? Incidunt, consectetur.
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Eum culpa placeat, maxime autem dolore nobis sit numquam quidem excepturi ex aut debitis corrupti in animi rem laborum quod doloribus quis?
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Eum culpa placeat, maxime autem dolore nobis sit numquam quidem excepturi ex aut debitis corrupti in animi rem laborum quod doloribus quis?
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Eum culpa placeat, maxime autem dolore nobis sit numquam quidem excepturi ex aut debitis corrupti in animi rem laborum quod doloribus quis?
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Eum culpa placeat, maxime autem dolore nobis sit numquam quidem excepturi ex aut debitis corrupti in animi rem laborum quod doloribus quis?
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Eum culpa placeat, maxime autem dolore nobis sit numquam quidem excepturi ex aut debitis corrupti in animi rem laborum quod doloribus quis?
            ...
            <div className='flex justify-start flex-[0.8]'>
              {question.category === 'MCQ' && (
                <div className='w-full'>
                  <h1 className='text-lg font-semibold mb-6 text-sky-900'>Choose the correct option</h1>
              ...
              {question.category === 'Text' && (
                <div className='w-full'>
                  <TextField variant='standard' label='Enter Answer' />
                </div>
              )}
            </div>
          </div>
