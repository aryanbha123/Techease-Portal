...
import { addOption, addQuestion, addQuestions, addQuiz, getParticularQuiz, getQuiz } from '../controllers/QuizControllers.js';
...
app.post('/quiz/add/questions', addQuestions);
